...
// I sistemi di compressione (come Protobuf o Delta Encoding) lavorano meglio con numeri piccoli. In complemento a due, 
// un numero negativo piccolo (es. -1) ha una rappresentazione binaria "pesante" (0xFF...).
// La codifica ZigZag "trasla" il segno nel bit meno significativo (LSB):i numeri positivi n diventano 2n (pari).
// i numeri negativi n diventano 2|n| - 1 (dispari).
// Risultato: i numeri con piccolo valore assoluto (vicini allo zero) sono ora rappresentati da piccoli numeri unsigned, 
// permettendo ad  algoritmi di codifica a lunghezza variabile (come Varint,RLE o Huffman) di risparmiare spazio critico.
